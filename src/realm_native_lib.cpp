...
static int _lib_realm_app_create(lua_State* L) {
    ...
    // Possibly set more fields on the config object (if also passed from Lua)
...
static int _lib_realm_app_register_email(lua_State* L) {
...
static int _lib_realm_app_credentials_new_email_password(lua_State* L) {
...
static int _lib_realm_app_log_in(lua_State* L) {
...
static int _lib_realm_user_log_out(lua_State* L) {
...
static int _lib_realm_user_get_id(lua_State* L) {
